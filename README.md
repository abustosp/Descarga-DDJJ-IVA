# Descarga DDJJ IVA y Extracción a Excel

Bot de descarga de DDJJ de IVA del servicio de Mis Aplicaciones Web de AFIP y posterior extracción a Excel con stript de python.
...
4. Descargar el BOT. Acá hay 3 opciones:
   ...
   3. Descargar el repositorio con GIT utilizando el comando `git clone https://github.com/abustosp/Descarga-DDJJ-IVA.git`
...
una vez descargados los archivos se debe:

1. Activar el entorno virtual con el comando `.\NombreDeTuEntornoVirtual\Scripts\activate` o `source NombreDeTuEntornoVirtual/bin/activate`

2. Instalar las librerías con el comando `pip install -r requirements.txt`

3. Ejecutar el script con el comando `python DJ.py` o `python3 DJ.py`
